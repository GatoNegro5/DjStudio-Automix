...
class _FixLyricsModalState extends ConsumerState<FixLyricsModal> {
  ...
  // ---------------------------------------------------------
  // 🛠️ PIPELINE DE RESCATE ATÓMICO (LABORATORIO IN-SITU)
  // ---------------------------------------------------------
  Future<void> _rescueTrackFromYoutube(String url) async {
    setState(() {
      _isSearching = true;
      _results = [];
    });
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: Row(
        ...
        children: [
          const Text(
            "Rescate de Pista / Letra (LRCLIB o YT)",
            style: TextStyle(
              color: Color(0xFF00FFFF),
              fontWeight: FontWeight.bold,
              fontSize: 14,
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: const InputDecoration(
                      hintText: "Ej: Elefante Angel O PEGA UN LINK DE YOUTUBE",
